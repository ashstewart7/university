% !TeX root = main.tex
\lecture{9}{Mon 02 Mar 2026 12:00}{Cosmology III: Friedmann Equation}
...
\begin{itemize}
    ...
    \item $k>0$: A positive-curvature (closed) universe with spherical geometry, analogous to the surface of a sphere.
    \item $k<0$: A negative-curvature (open) universe with hyperbolic geometry, analogous to the surface of a saddle.
\end{itemize}
