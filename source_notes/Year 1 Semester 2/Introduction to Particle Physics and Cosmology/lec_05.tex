% !TeX root = main.tex
\lecture{5}{Mon 09 Feb 2026 12:00}{Particle Physics V: Calorimetry}
...
After depth $t$ (in units of $X_0$), the number of particles is $2^t$, and the average particle energy is $E_0 / 2t$. 

The shower stops developing after $E = \frac{E_0}{2t} < E_c$. This happens when $E = 2^t = E_0/E_c$. Hence:
