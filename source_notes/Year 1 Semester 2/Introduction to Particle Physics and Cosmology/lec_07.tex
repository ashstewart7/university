% !TeX root = main.tex
\lecture{7}{Mon 23 Feb 2026 12:00}{Cosmology I: A Brief Introduction to Cosmology}
...
The fundamental building block of the the universe is galaxies. This cluster themselves together into filaments. While on a local scale, we  see very large gaps between these, on a large enough scale (i.e. zoomed out enough) we see that the universe is very smooth on average. We say that, on cosmological scales, the distribution of matter is homogeneous and isotopic (has identical physical properties in all directions with uniform structure).

\subsection{Cosmic Microwave Background}
There is a nearly isotropic low frequency radiation background that penetrates the entire universe. It has an almost perfect black body spectrum with $T \sim 2.73$K. This is in the microwave region.

\subsection{Discovery of Dark Matter}
