% !TeX root = main.tex
\lecture{12}{Tue 03 Mar 2026 11:00}{Special Relativity IV: More Space-Time}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.35\textwidth]{figures/lec12-03.png}
     \caption{}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.35\textwidth]{figures/lec12-04.png}
     \caption{}
\end{figure}
...
\subsection{Problem}
Let the ladder have proper length $l_0^L = 20$m and the garage have proper length $l_0^G = 10$m. The ladder moves at $0.9$c wrt the garage.

\[
    \gamma = \frac{1}{\sqrt{1 - \beta^2}} = \frac{1}{\sqrt{1-0.9^2}} \approx 2.29
\]

In the garage's rest frame, the ladder length is $L^L = \frac{20}{2.29} = 8.7$m. So, from the garage's POV, the ladder fits!

We now consider the length of the garage from the ladder's rest frame: $L^G = \frac{10}{2.29} = 4.4$m, so from the ladder's POV, the ladder cannot fit! This creates a paradox.
...
\begin{itemize}
    \item A. The front of the ladder reached the back garage door (the first figure)
    \item B. The back of the ladder reaches the front garage door.
\end{itemize}
...
$$
\Delta t_{AB}^\prime = \gamma \left(\Delta t_{AB} - \frac{v}{c^2} \Delta x_{AB}\right) = \frac{\gamma v}{c^2} \Delta x_{AB} \not = 0
$$
