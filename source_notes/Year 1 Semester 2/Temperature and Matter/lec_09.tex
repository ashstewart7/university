% !TeX root = main.tex
\lecture{9}{Tue 17 Feb 2026 12:00}{Thermal Physics III: Laws of Thermodynamics}
...
\[
    \boxed{PV = nRT}
\]
Where $n$ is the number of moles and $R = 8.314 \text{J} \text{mol}^{-1} \text{K}^{-1}$ is the gas constant.
