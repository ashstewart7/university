% !TeX root = main.tex
\lecture{12}{Thu 26 Feb 2026 13:00}{Thermal Physics VI: Heat Transfer}
...
Eventually, we reach a ``steady state'' where all points on the road have a $\dot{Q}$ which does not change with time.
