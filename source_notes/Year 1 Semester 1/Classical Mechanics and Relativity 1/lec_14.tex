% !TeX root = main.tex
\lecture{14}{Thu 13 Nov 2025 15:00}{Mechanics X: Conservation of Energy}

\section{Work Done Example I}

\textcolor{red}{Do not read this lecture without also taking Section 1 of Lec 15 into account.}
...
Assume there is some friction with $\mu_\text{kinetic} = \mu$, we therefore have to account for work done by this:
\[
    E_A + W_{A \to B} = E_B
\]
...
Note these \textbf{important things}:
\begin{itemize}
    \item The work done is negative, as it is work done against the motion by friction.
    \item We assume that we move infinitesimally slowly, therefore we disregard centripetal force. Yes this is slightly (very) contradictory to the premise of the problem, as high velocity is required to climb but it's an approximation. This is looked at next lecture.
