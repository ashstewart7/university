% !TeX root = main.tex
\lecture{2}{Thu 02 Oct 2025 15:00}{Mechanics II: Dimensional Analysis and Vectors}
...
\]
\[
    G = 6.67 \times 10^{-11} N m^2 / kg^2nvm install 20
\]
\[
    c = 3 \times 10^8 m/s
\]
...
Again, vector notation will be $\vec{a}$. We define the x, y, z unit vectors as $\hat{e_x}, \hat{e_y}, \hat{e_z}$.
...
\]
As the vector perpendicular to the plane containing a and b. It is in the direction given by the \emph{right hand rule}, where curling four fingers into a fist, and orienting your fist so these fingers sweep from $\vec{a}$ to $\vec{b}$, the new vector will point in the direction of an extended thumb. Theta is the angle between a and b, while j is the unit vector in the direction the new vector will point.
...
Therefore total energy received is approximately:
\[
