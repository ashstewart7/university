...
Where the first term is the density of nodes at lambda, and the second is the average energy of nodes. As we head to UV and $\lambda \to 0$, $I(\lambda) \to \infty$\dots which is not accurate. This is the UV Catastrophe!
