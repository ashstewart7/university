...
Note that $E \propto n^2$ in an infinitely deep 1D potential well. Compare this to $E \propto \frac{1}{n^2}$ in a H atom.
...
Note that in a 2D system, $\Delta p_x \Delta y$ is unrestricted as they are independent and non-conjugate observables. In our example:
\[
