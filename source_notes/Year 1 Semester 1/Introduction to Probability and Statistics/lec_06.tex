% !TeX root = main.tex
\lecture{S6}{Thu 16 Oct 2025 09:00}{Likelihood and Log Likelihood}
...
\[
    P(\epsilon_i \mid \theta) = P(\epsilon_i) = \frac{1}{\sigma_{D_i} \sqrt{2 \pi}} \exp \left(\frac{-\epsilon_i^2}{2 \sigma^2_{D_i}}\right)
\]
...
\[
    P(D_i \mid \theta) = \frac{1}{\sigma_{D_i} \sqrt{2 \pi}} \exp{\left(\frac{-(D_i - M(t_i, \theta))^2}{2 \sigma^2_{D_i}}\right)}
\]
...
The high likelihood values of $P(D\mid\tau)$ are the models which are most likely to generate the observed data, given the parameters. This, therefore, means that they are the models which best fit the data.
...
\]
\[
    \ln P(D_i \mid \theta) = \ln\left(\frac{1}{\sigma_{D_i} \sqrt{2 \pi}} \exp{\left(\frac{-(D_i - M(t_i, \theta))^2}{2 \sigma^2_{D_i}}\right)}\right)
\]
\[
    \ln P(D_i \mid \theta) = \ln\left(\frac{1}{\sigma_{D_i} \sqrt{2 \pi}}\right) +\ln\left(\exp{\left(\frac{-(D_i - M(t_i, \theta))^2}{2 \sigma^2_{D_i}}\right)}\right)
\]
\[
    \ln P(D_i \mid \theta) = \left(\frac{-(D_i - M(t_i, \theta))^2}{2 \sigma^2_{D_i}}\right) - \ln\left(\sigma_{D_i}\right) - \ln \left(\sqrt{2 \pi}\right)
\]
...
\[
    \ln P(D_i \mid \theta) = \left(\frac{-(D_i - M(t_i, \theta))^2}{2 \sigma^2_{D_i}}\right) + \text{constant}
\]

This gives the final log likelihood as:
\[
    \boxed{\mathcal{L} = \ln P(D\mid\theta) = \sum_{i=1}^{n} \ln P(D_i \mid \theta) = \sum_{i=1}^{n} \left(\frac{-(D_i - M(t_i, \theta))^2}{2 \sigma^2_{D_i}}\right)}
\]
...
\[
    \frac{\partial}{\partial \tau} \ln P(D \mid \tau) = 0
\]
...
\begin{bmatrix}
\displaystyle 
\dfrac{\partial^2 \LL}{\partial \theta_1^2}\biggr\rvert_{\theta=\hat{\theta}} &
\displaystyle 
\dfrac{\partial^2 \LL}{\partial \theta_1 \partial \theta_2}\biggr\rvert_{\theta=\hat{\theta}} &
\cdots &
\displaystyle 
\dfrac{\partial^2 \LL}{\partial \theta_1 \partial \theta_k}\biggr\rvert_{\theta=\hat{\theta}}
\\[1.0em]
\displaystyle 
\dfrac{\partial^2 \LL}{\partial \theta_2 \partial \theta_1}\biggr\rvert_{\theta=\hat{\theta}} &
\displaystyle 
\dfrac{\partial^2 \LL}{\partial \theta_2^2}\biggr\rvert_{\theta=\hat{\theta}} &
\cdots &
\displaystyle 
\dfrac{\partial^2 \LL}{\partial \theta_2 \partial \theta_k}\biggr\rvert_{\theta=\hat{\theta}}
\\[1.0em]
\vdots & \vdots & \ddots & \vdots
\\[1.0em]
\displaystyle 
\dfrac{\partial^2 \LL}{\partial \theta_k \partial \theta_1}\biggr\rvert_{\theta=\hat{\theta}} &
\displaystyle 
\dfrac{\partial^2 \LL}{\partial \theta_k \partial \theta_2}\biggr\rvert_{\theta=\hat{\theta}} &
\cdots &
\displaystyle 
\dfrac{\partial^2 \LL}{\partial \theta_k^2}\biggr\rvert_{\theta=\hat{\theta}}
\end{bmatrix}.
\]
