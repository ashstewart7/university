...
\]
\[
    \ln P(D_i \mid \theta) = \left(\exp{\left(\frac{-(D_i - M(t_i, \theta))^2}{2 \sigma^2_{D_i}}\right)}\right) - \ln\left(\sigma_{D_i}\right) - \ln \left(\sqrt{2 \pi}\right)
\]
...
\[
    \ln P(D_i \mid \theta) = \left(\exp{\left(\frac{-(D_i - M(t_i, \theta))^2}{2 \sigma^2_{D_i}}\right)}\right) + \text{constant}
\]

This gives the final log likelihood as:
\[
    \boxed{\mathcal{L} = \ln P(D\mid\theta) = \sum_{i=1}^{n} P(D_i \mid \theta) = \sum_{i=1}^{n} \left(\exp{\left(\frac{-(D_i - M(t_i, \theta))^2}{2 \sigma^2_{D_i}}\right)}\right)}
\]
