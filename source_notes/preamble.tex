...
\begin{titlepage}
    \centering
    \includegraphics[width=0.3\textwidth]{/home/ash/Documents/uni/source_notes/uobcrest.png}
    ...
    {\large \@author \par}
    \large{MSci Physics with Particle Physics and Cosmology}\\   
\end{titlepage}
}
\makeatother