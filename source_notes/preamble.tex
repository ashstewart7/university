...
\let\saveddot\dot%chktex 14
\let\savebar\bar%chktex 14
\usepackage{accents}
\let\mathdot\saveddot
\let\dot\mathdot%Fix the accents package breaking dot
\let\bar\savebar

\renewcommand{\hat}[1]{\accentset{\wedge}{#1}}
\renewcommand{\dot}[1]{\mathdot{#1}}
...
\addto\captionsenglish{\renewcommand{\contentsname}{Table of Lectures}}
...
\fancyhead[L]{\currentlecture}
\fancyhead[R]{Page \thepage}
\fancyfoot[R]{Ash's Lecture Notes}
...
\newcommand{\lecture}[3]{%
    ...
    \ifthenelse{\isempty{#3}}{%
        ...
        \gdef\currentlecture{Lecture #1}%
    }{%
        \addcontentsline{toc}{chapter}{Lecture #1: \textnormal{#3}}%
        \chapter*{\small{#2}\\\LARGE{Lecture #1 - #3}}%
        \gdef\currentlecture{Lecture #1 - #3}%
    }\thispagestyle{fancy}}
