...
\mathbf{H} =
\begin{bmatrix}
\frac{\partial^{2}\LL}{\partial \theta_{1}^{2}} \bigr\rvert_{\theta=\hat{\theta}} &
\frac{\partial^{2}\LL}{\partial \theta_{1}\partial \theta_{2}} \bigr\rvert_{\theta=\hat{\theta}} \\[8pt]
\frac{\partial^{2}\LL}{\partial \theta_{2}\partial \theta_{1}} \bigr\rvert_{\theta=\hat{\theta}} &
\frac{\partial^{2}\LL}{\partial \theta_{2}^{2}} \bigr\rvert_{\theta=\hat{\theta}}
\end{bmatrix}
\]}
