...
% !TeX root = main.tex
\lecture{4}{Fri 24 Oct 2025 12:00}{Atomic Energy Levels and Spectra}
...
The `Balmer Series' is a portion of the hydrogen emission spectra which happens to take place at visible wavelengths. It is specifically transitions which take place to n = 2. To find these wavelengths, we set $n = 2$:

\[
    \frac{1}{\lambda} = R\left(\frac{1}{2^2} - \frac{1}{n^2} \right)
\]

Moving from $3 \to 2$ gives us the Balmer Alpha line, for example.
