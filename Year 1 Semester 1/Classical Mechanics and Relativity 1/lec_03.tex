...
\]
\[
    \int_{v_0}^{v} dv = \int_{t_0}^{t} a_o \, dt = a_0 \int_{t_0}^{t} dt
\]
\[
    v - v_0 = a_0(t-t_0)
\]
...
And now the position function:
\[
    v = \frac{dx}{dt}
\]
\[
    \int_{x_0}^{x} v \, dt = \int_{t_0}^{t} v_0 + a_0(t-t_0) \, dt
\]

\[
    x-x_0 = v_0(t-t_0)+\frac{1}{2}a_0(t-t_0)^2
\]